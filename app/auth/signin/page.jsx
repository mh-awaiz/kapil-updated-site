  ...
  return (
    <div className="min-h-screen bg-[#22323c] flex items-center justify-center px-4 pt-20">
      <div className="bg-[#1a2830] rounded-2xl p-8 w-full max-w-sm border border-white/5 text-center shadow-2xl">
        ...
        />
        <h1 className="text-2xl font-black text-[#17d492] mb-2">Welcome Back</h1>
        <p className="text-slate-400 text-sm mb-8 font-medium">
          Sign in to track your orders and checkout faster
        </p>
        <button
          onClick={() => signIn("google", { callbackUrl })}
          className="w-full flex items-center justify-center gap-3 bg-white text-gray-800 py-3.5 px-6 rounded-xl font-black hover:bg-gray-100 transition shadow-md"
        >
